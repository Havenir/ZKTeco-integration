...
def execute(filters=None):
    ...
    employee_condition = f"AND ec.employee = '{employee_filter}'" if employee_filter else ""
    date_condition = f"AND ec.time BETWEEN '{from_date}' AND '{to_date}'" if from_date and to_date else ""
